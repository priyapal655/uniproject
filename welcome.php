	...
	<div class="header-top">
		<div class="container">
			<div class="bottom_header_left">
				<p>
					<span class="fa fa-map-marker" aria-hidden="true"></span>New Kampshire Mshinon, USA <strong>Welcome </strong><?php echo $_SESSION['em'];				?>
				</p>
			</div>
			<div class="bottom_header_right">
				...
				</form>		<!--<span class="fa fa-sign-out" aria-hidden="true"></span>Logout</a>-->
				</div>
